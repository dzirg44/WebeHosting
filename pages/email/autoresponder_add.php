	...
	<body>
		<nav id='cssmenu' class="inner">
			<ul>
				...
				<li class='kop'>
					<a href='../../logout.php'><img src="../../images/logout.jpg" class="nav-img"><span
				...
				<div class="tab">
					...
					<div class="div">
						<form method="post" class="form" action="" enctype="multipart/form-data">
							...
							</select> <label for="from">From</label>
							<?= $fromErr; ?>
							<input id="from" type="text" name="from" placeholder="Abraham Lincoln" class="input"> <label
					...
					<div class="div" style="position: absolute;">
						...
						<br> <input type="date"
									...
									class="input"> <br> <br> <label for="endDateTime">Stop</label>
						<?= $endDateTimeErr; ?>
						<br> <input type="date"
									id="endDateTime"
									name="endDateTime"
									placeholder="YYYY-MM-DD"
									class="input"> <br> <input class="blue-button"
															   type="submit"
															   value="Create / Modify"
															   name="submit"/></form>
					</div>
