	...
	<body>
		<nav id='cssmenu' class="inner">
			<ul>
				...
				<li class='kop'>
					<a href='#' class="dashboard active"><img src="images/home.jpg"
				...
				<li class='kop index-email-kopdown'>
					<a href='#'><img src="images/mail.png"
									 class="nav-img"><span class="hidden-xs menu-text index-email-kopdownn">E-mail</span></a>
				...
				<li class='kop'>
					<a href='#'><img src="images/cloud.jpg"
									 class="nav-img"><span class="hidden-xs menu-text">Server</span></a>
				</li>
				<li class='kop'>
		...
		<div class="content">
			...
			<div class="offer">
				<p class="offer-float">NEW CDN <br>SERVICE</p>

				<p class="offer-padding hidden-xs">From <br> $0.01/GB</p>
